...
class ContactController extends Controller
{
    public function contact(){
        ...
        if (isset(Auth()->user()->id)) {
            ...
            return view('user.contact.index', compact( 'cartHead', 'countCart', 'book_type', 'bookDetail', 'count', 'topauthor'));
        }else{
            return view('user.contact.index', compact(  'book_type', 'bookDetail','count', 'topauthor'));
        }
    }
}
