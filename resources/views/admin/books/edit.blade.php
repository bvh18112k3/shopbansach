    ...
    <div class="container-fluid">
        <form action="{{route('admin.books.update', $book->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" value="{{$book->publishing_company}}" name="publishing_company" class="form-control">
            ...
            <div>
                ...
                <input type="date" value="{{$book->publishing_year}}" name="publishing_year" class="form-control">
            ...
            <div>
                ...
                <input type="number" value="{{$book->pages}}" name="pages" class="form-control">
                @error('pages')
                <p style="color: red">{${$message}}</p>
                @enderror
            </div>
            <div>
                ...
                <input type="number" value="{{$book->weight}}" name="weight" class="form-control">
                @error('weight')
                <p style="color: red">{{$message}}</p>
                @enderror
            </div>
            <div>
                ...
                <input type="text" value="{{$book->size}}" name="size" class="form-control">
                @error('size')
                <p style="color: red">{{$message}}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" value="{{$book->discount}}" name="discount" class="form-control">
                @error('discount')
                <p style="color: red">{{$message}}</p>
                @enderror
            </div>
