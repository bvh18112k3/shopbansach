                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="tg-innerbannercontent">
                        ...
                        <ol class="tg-breadcrumb">
                            ...
                            <li class="tg-active"><a href="">Tìm kiếm</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div id="tg-content" class="tg-content">
                                <div class="tg-products">
                                    <div class="tg-sectionhead">
                                        <h2><span>Sự lựa chọn của mọi người</span>Kết quả tìm kiếm từ khóa "{{$s}}"</h2>
                                    </div>
                                    ...
                                    <div class="tg-productgrid">
                                        ...
                                        @if(empty($data))
                                            <h4>Rất xin lỗi vì không có sản phẩm nào phù hợp với tìm kiếm của bạn </h4>
                                        @else
                                                    ...
                                                    <div class="tg-postbook">
                                                        ...
                                                        <div class="tg-postbookcontent">
                                                            ...
                                                            <span class="tg-bookwriter">By: <a
                                                                    href="{{route('author_detail', $item->author_id)}}">{{$item->author}}</a></span>
                                                            @foreach($review as $r)
                                                                @if($r->book_id == $item->id)
                                                                    @if($r->star == null && $r==null)
