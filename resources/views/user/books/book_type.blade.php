                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="tg-innerbannercontent">
                        ...
                        <ol class="tg-breadcrumb">
                            ...
                            <li class="tg-active"><a href="">{{$bt->name}}</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="tg-featureditm">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 hidden-sm hidden-xs">
                                                    <figure><img style="width: 241px; height: 298px" src="{{asset($book_hot->image)}}" alt="image description">
                                                    </figure>
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="tg-featureditmcontent">
                                                        ...
                                                        <span class="tg-bookwriter">By: <a href="{{route('author_detail', $book_hot->author)}}">{{$book_hot->Author->name}}</a></span>
                                                        @php
                                                            $reviewed = false;
                                                        @endphp
                                                        @foreach($review as $r)
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
                                                <div class="tg-postbook">
                                                    <figure class="tg-featureimg">
                                                        <div class="tg-bookimg">
                                                            <div class="tg-frontcover"><img
                                                                    src="{{asset($item->Book->image)}}"
                                                                    alt="image description"></div>
                                                            <div class="tg-backcover"><img src="{{asset($item->Book->image)}}"
                                                    ...
                                                    <div class="tg-postbookcontent">
                                                        <div class="tg-themetagbox"><span class="tg-themetag">sale {{$item->Book->discount}}%</span>
                                                        </div>
                                                        <div class="tg-booktitle">
                                                            <h3>
                                                                <a href="{{route('book-detail', ['id'=>$item->Book->id, 'author_id'=>$item->Book->author_id])}}">{{$item->Book->name}}</a>
                                                            </h3>
                                                        </div>
                                                        <span class="tg-bookwriter">By: <a
                                                                href="{{route('author_detail', $item->Book->author)}}">{{$item->Book->Author->name}}</a></span>
                                                        @php
                                                            $reviewed = false;
                                                        @endphp
                                                        @foreach($review as $r)
                                                            @if($r->book_id == $item->Book->id)
                                                                @php
                                                                    $reviewed = true;
                                                                @endphp
                                                                <div class="rating @if($r->star == 1) stars1
                                                    ...
                                                    @else stars0 @endif">
                                                        ...
                                                        @endif
                                                        <span class="tg-bookprice">
															<ins>{{number_format($item->Book->price - ($item->Book->price*$item->Book->discount)/100, 0, '', '.')}}đ</ins>
                                                            <del>{{number_format($item->Book->price, 0, '', '.' )}}đ</del>
														</span>
                                                        <form method="post" action="{{route('postCart')}}">
                                                            @csrf
                                                            ...
                                                            <input type="hidden" name="quantity" value="1">
                                                            <input type="hidden" name="sum_money"
                                                                   value="{{$item->Book->price - ($item->Book->price*$item->Book->discount)/100}}">
                                                            <input type="hidden" value="" name="note">
                                                            <button class="tg-btn tg-btnstyletwo" type="submit">
                                                                <i class="fa fa-shopping-basket"></i>
                                                                <em>Add To Basket</em>
